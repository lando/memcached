...
This guide contains information to help onboard developers to work on the [Memcached](https://memcached.org/) integration, hereafter referred to as "the plugin".
